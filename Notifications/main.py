...
if Hour <= 6: # If Hour is less than 6 then you'll have dark mode, if it's past 6 AM then you'll have light mode
...
Window.geometry("370x300") # Size of it
...
PasteContent.place(x=260, y=148)
